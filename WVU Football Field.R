...
mypngfile <- download.file('https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/West_Virginia_Mountaineers_logo.svg/233px-West_Virginia_Mountaineers_logo.svg.png', destfile = 'mypng.png', mode = 'wb')
mypng <- readPNG('mypng.png')

####This is the Big 12 logo
mypngfile2 <- download.file('https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Big_12_logo_in_West_Virginia_colors.svg/1280px-Big_12_logo_in_West_Virginia_colors.svg.png', destfile = 'mypng2.png', mode = 'wb')
mypng2 <- readPNG('mypng2.png')
...
football_field <- ggplot()+
  ...
  geom_rect(aes(xmin = 0, xmax = 10, ymin = 0, ymax = 53.33), fill = "#002855", colour = "#FFFFFF") + ##These two are the end-zones and colors
  geom_rect(aes(xmin = 110, xmax = 120, ymin = 0, ymax = 53.33), fill = "#002855", colour = "#FFFFFF") +
  ...
  annotate(geom ="text", x = 5, y = 27, label = "WEST VIRGINIA", colour = "#EAAA00", family = 'Helvetica Neue',fontface = 2, angle = 90, size = 13) +
  annotate(geom ="text", x = 115, y = 27, label = "MOUNTAINEERS", colour = "#EAAA00", family = 'Helvetica Neue',fontface = 2, angle = 270, size = 12) +
  # have to get the right font for the endzones :)
  
  
  annotation_raster(mypng2, ymin = 34.5, ymax = 40, xmin = 32, xmax = 38) + ##This is where you add the Big 12 Logos
  annotation_raster(mypng2, ymin = 14, ymax = 19.5, xmin = 82, xmax = 88) + ##This is where you add the Big 12 Logos
  
  annotation_raster(mypng, ymin = 20, ymax = 33.5, xmin = 55, xmax = 65) + ##This is where you add the Midfield Logo
  ...
  theme(rect = element_blank(), ##This removes all of the exterior lines from a typical ggplot
        line = element_blank(),
        text = element_blank()) +
  ggsave("WVU Football Field.png", width = 12, height = 5.5)
